...
var StyledRow = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  > * {\n    ", "\n\n    ", "\n  }\n\n  > *:last-child {\n    margin-bottom: 0;\n  }\n\n  > *:first-child {\n    margin-top: 0;\n  }\n"])), function (props) {
  ...
  return props.forceDisplay && (0, _styledComponents.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n        display: block;\n      "])));
});
...
Rows.propTypes = {
   ...
   */
  forceDisplay: _propTypes.default.bool,
  spacing: _propTypes.default.oneOf(['m', 'l', 'xl'])
};
Rows.defaultProps = {
  spacing: 'l'
};
